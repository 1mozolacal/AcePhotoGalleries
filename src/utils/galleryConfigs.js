...
import long_shot_of_rail_bridge from '../images/gallery/LONG SHOT VIEW OF RAIL BRIDGE OVER GRAND RIVER IN CAMBRIDGE ON.jpg'
import picturesque_river_through_the_trees from '../images/gallery/SPECIAL FILTER VIEW OF GRAND RIVER AND FOREGROUND FOLIAGE (2).jpg';
import wooden_bridge_along_water from '../images/gallery/AMAZING WOODEN WALKING TRAIL ALONGSIDE GRAND RIVER WITH SPECIAL FILTER.jpg';
import arc_de_triomphe from '../images/gallery/ARC DE TRIOMPHE IN PARIS FRANCE.jpg';
import la_louvre_museum_painted_art_ceiling from '../images/gallery/INCREDIBLE SHOT OF PAINTED CEILING OF THE LOUVRE ART MUSEUM THAT HOUSES LA MONA LISA.jpg';
import under_the_base_of_the_famous_eiffel_tower_in_paris from '../images/gallery/SHOT UP THE MIDDLE OF THE EIFFEL TOWER AT NIGHT IN PARIS FRANCE.jpg';
import the_grotto from '../images/gallery/ENTRANCE TO GROTTO CAVE IN TOBERMORY ONTARIO WOW LOOK AT THE WATER COLORS.jpg';
import new_york_subway from '../images/gallery/NY SUBWAY TRACK 22.jpg';
import rail_bridge_with_train from '../images/gallery/TRAIN CROSSING RAIL BRIDGE OVER GRAND RIVER.jpg';
import old_log_dump_side_of_the_grotto from '../images/gallery/THE OTHER SIDE OF THE GROTTO IN TOBERMORY.jpg';
import the_eiffel_tower_lit_at_night_in_paris_france from '../images/gallery/ONE OF A KIND PICTURE OF PARIS FRANCE S EIFFEL TOWER LIGHTED AT NIGHT FROM BEHIND SECURITY BARRIERS.jpg';
import beachfront_restaurant_in_mexican_riviera from '../images/gallery/PLAYA DEL CARMEN OCEANSIDE RESTAURANT AND BEACH.jpg';
import centuries_old_highschool_two from '../images/gallery/HOGWARTS LOOKALIKE GCI SCHOOL IN GALT ONTARIO WITH SPECIAL FILTER.jpg';
import sunrise_in_agawa_two from '../images/gallery/SUNSET IN AGAWA CANYON BEACH.jpg';
...
export const imageDictionary = {
	...
	//SECOND BATCH
	"hiram walkers head office building": hiram_walkers_head_office_building,
	"mexican oasis and gardens": mexican_oasis_and_gardens,
	"agawa mountainside waterfall": agawa_mountainside_waterfall,
	"mill destroyed on the grand": mill_destroyed_on_the_grand,
	"old fishing camp on the river": old_fishing_camp_on_the_river,
	"mill destroyed": mill_destroyed,
	"leviathan at versailles": leviathan_at_versailles,
	"black and white river view": black_and_white_river_view,
	"louis the 14th statue in paris france": louis_the_14th_statue_in_paris_france,
	"mayan tiki huts": mayan_tiki_huts,
	"winter wonderland": winter_wonderland,
	"canadian house of commons historic architecture": canadian_house_of_commons_historic_architecture,
	"b w of underbelly of ambassdor bridge": b_w_of_underbelly_of_ambassdor_bridge,
	"estuary at singing sands beach": estuary_at_singing_sands_beach,
	"majestic ceiling of louvre museum": majestic_ceiling_of_louvre_museum,
	"extraordinary stained glass in house of commons": extraordinary_stained_glass_in_house_of_commons,
	"light tunnel": light_tunnel,
	"trail along the shore": trail_along_the_shore,
	"central park in autumn": central_park_in_autumn,
	"rustic barn": rustic_barn,
	"rocky shoreline of bruce peninsula": rocky_shoreline_of_bruce_peninsula,
	"pagoda plantation in beijing china": pagoda_plantation_in_beijing_china,
	"paris france boulevard": paris_france_boulevard,
	...
	"long shot of rail bridge":long_shot_of_rail_bridge,
	"picturesque river through the trees":picturesque_river_through_the_trees,
	"wooden bridge along water":wooden_bridge_along_water,
	"arc de triomphe":arc_de_triomphe,
	"la louvre museum painted art ceiling":la_louvre_museum_painted_art_ceiling,
	"under the base of the famous eiffel tower in paris":under_the_base_of_the_famous_eiffel_tower_in_paris,
	"the grotto":the_grotto,
	"new york subway":new_york_subway,
	"rail bridge with train":rail_bridge_with_train,
	"old log dump side of the grotto":old_log_dump_side_of_the_grotto,
	"the eiffel tower lit at night in paris france":the_eiffel_tower_lit_at_night_in_paris_france,
	"beachfront restaurant in mexican riviera":beachfront_restaurant_in_mexican_riviera,
	"centuries old highschool two":centuries_old_highschool_two,
