...
export const displaySettingsInitial = [
	...
	//Remove because dup issue ["centuries old highschool",6, "Hogwarts Lookalike GCI School with filter"],
	...
	//removed because of dup ["sunrise in agawa",6, "Sunset in Agawa Canyon Beach"],
